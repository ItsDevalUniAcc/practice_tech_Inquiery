...
def main():
    ...
    pygame.display.set_caption("Car Parking Puzzle - Level 2")
    clock = pygame.time.Clock()

    # Create the level for level 2 - Medium difficulty
    level = Level(
        difficulty="Medium",
        cars=[
            ...
            {'x': 3, 'y': 4, 'length': 2, 'horizontal': True, 'color': COLORS['other_car']},
            {'x': 1, 'y': 5, 'length': 2, 'horizontal': True, 'color': COLORS['truck']}
        ],
        exit_pos=(6, 2),
        perfect_moves=8
    )
