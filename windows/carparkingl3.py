...
def main():
    ...
    pygame.display.set_caption("Car Parking Puzzle - Level 3")
    clock = pygame.time.Clock()

    # Create the level for level 3 - Hard difficulty
    level = Level(
        difficulty="Hard",
        cars=[
            ...
            {'x': 4, 'y': 0, 'length': 3, 'horizontal': False, 'color': COLORS['truck']},
            {'x': 0, 'y': 3, 'length': 2, 'horizontal': True, 'color': COLORS['truck']},
            {'x': 3, 'y': 3, 'length': 2, 'horizontal': True, 'color': COLORS['other_car']},
            {'x': 1, 'y': 4, 'length': 2, 'horizontal': False, 'color': COLORS['other_car']},
            {'x': 3, 'y': 5, 'length': 2, 'horizontal': True, 'color': COLORS['truck']}
        ],
        exit_pos=(6, 2),
        perfect_moves=12
    )
