...
pygame.display.set_caption("English Pro")
...
words = [
    "cat", "dog", "sun", "hat", "run", "bed", "mom", "dad", "book", "fish",
    "ball", "pen", "cup", "milk", "red", "blue", "tree", "bird", "frog", "car"
]
...
def main():
    ...
    for word in word_completion_words:
        missing_indices = random.sample(range(len(word)), k=max(1, len(word) // 3))
