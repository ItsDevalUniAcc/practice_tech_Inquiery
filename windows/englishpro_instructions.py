...
def show_instructions(screen):
    ...
    # How to Play heading
    how_to_play_text = heading_font.render("How to Play English Pro", True, BLACK)
    ...
    instructions = [
        "English Pro is a 2-Phase Challenge:",
        "",
        "Phase 1: Word Completion",
        "- You will be shown 5 words with missing letters",
        "- Fill in the blanks to complete each word",
        "- Type your answer and press Enter to submit",
        "- You'll earn 1 point for each correct word",
        "",
        "Phase 2: Memory Game",
        "- You will be shown 5 different words to memorize",
        "- Each word appears for 3 seconds",
        "- After it disappears, type the word from memory",
        "- You'll earn 1 point for each word you recall correctly",
        "",
        "Scoring:",
        "- Maximum score: 10 points (5 from each phase)",
        "- Your total score and time will be shown at the end",
        "",
        "Tips:",
        "- Focus on spelling each word correctly",
        "- For memory words, try to create a mental image",
        "- Practice regularly to improve your vocabulary and memory"
    ]
    ...
    while running:
        ...
        # Title
        title_text = title_font.render("English Pro", True, WHITE)
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("English Pro - Instructions")
    ...
    if result:
        ...
        import os
        os.system(f"{sys.executable} englishprol1.py")  # Start the game
    else:
        # User chose to quit
        pygame.quit()
        sys.exit()