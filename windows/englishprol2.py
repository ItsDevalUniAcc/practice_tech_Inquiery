...
pygame.display.set_caption("English Pro - Level 2")
...
# Level 2 has longer words
words = [
    "apple", "train", "chair", "school", "light", "water", "friend", "candy", "pencil", "jungle",
    "window", "doctor", "pocket", "yellow", "animal", "family", "cloud", "rocket", "market", "garden"
]
...
def main():
    ...
    for word in word_completion_words:
        # For level 2, increase the challenge by removing more letters
        missing_indices = random.sample(range(len(word)), k=max(2, len(word) // 2))
